...
class LocalPlanner:
    ...
    def get_goal_state_set(self, goal_index, goal_state, waypoints, ego_state):
        ...
        goal_state_local = rot_mat @ goal_state_local[:2]
        goal_x = goal_state_local[0]
        goal_y = goal_state_local[1]
        # goal_x = ego_state[0] * np.cos(theta) + ego_state[1] * -np.sin(theta)
        # goal_y = ego_state[0] * np.sin(theta) + ego_state[1] * np.cos(theta)
        # ------------------------------------------------------------------
